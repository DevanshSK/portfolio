...
const HeroContent = () => {
    return (
        <>
            <div className='bg-black z-0 min-h-[60%] sm:min-h-[50%] w-[75%] sm:w-[60%] rounded-tr-3xl md:w-1/2 absolute bottom-0 left-0 p-8 bg-red-300 flex flex-col items-center justify-center gap-4'>
