...
const Description = () => {
    ...
    return (
        <section ref={description} id='about' className='description sm:px-10 px-5 md:px-[80px] lg:px-[100px] pt-20 mb-0 md:pt-[90px] md:mb-[90px] lg:pt-[90px] z-10 flex justify-center'>
